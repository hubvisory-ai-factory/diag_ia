const CLIENT_DATA = {
  ...
  catalogueSolutions: [
    ...
    { id: "SN10.2", fonctionnalite: "Relance (CU-9 Pénalités Arquus)", produitId: "moteur_relance", objectif: `Automatiser la phase de relance des lignes représentants des visites en risque de pénalité.`, description: `L'agent Moteur de relance identifie les lignes de l'Excel nécessitant une justification et lance les relances nécessaires auprès des concessions concernées.`, votac: { valeur: 3, occurrence: 4, temps: 5, ia: 5, facilite: 4, total: 21 }, package: "P1", statut: "A valider", outils: ["N8N", "API Outlook", "Base de données Immat X Contact"], casUsageLies: ["CU-9"] },
    { id: "SN10.3", fonctionnalite: "Analyse & Intégration ERP (CU-9 Pénalités Arquus)", produitId: "moteur_relance", objectif: `Automatiser la complétude du fichier de pénalités suite aux justifications des concessionnaires.`, description: `L'agent synthétise les retours des concessions suite aux relances et intègre les justifications dans le fichier excel exposé en comité pénalités Arquus. Nécessite API Zadig écriture.`, votac: { valeur: 3, occurrence: 4, temps: 5, ia: 5, facilite: 2, total: 19 }, package: "P3", statut: "A valider", outils: ["N8N", "API Outlook", "Excel", "API ZADIG ECRITURE"], casUsageLies: ["CU-9"] },
    ...
    { id: "SN11.3", fonctionnalite: "Traitement GLPI", produitId: "assistant_plateforme", objectif: `Automatiser la création de tickets GLPI à partir des signalements Teams, en s'assurant que toutes les informations requises sont collectées avant soumission.`, description: `Détection automatique des bugs Zadig remontés dans Teams par les managers. L'agent collecte les informations complètes et crée le ticket GLPI directement, sans intervention manuelle.`, votac: { valeur: 5, occurrence: 4, temps: 3, ia: 5, facilite: 4, total: 1200 }, package: "P2", statut: "A valider", outils: ["VM", "Compte MS basic", "API GLPI"], casUsageLies: ["CU-11"] },
