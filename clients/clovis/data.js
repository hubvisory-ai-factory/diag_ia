const CLIENT_DATA = {
  ...
  catalogueSolutions: [
    ...
    { id: "SN10.2-CU8", fonctionnalite: "Relance (CU-8 Reporting VT4)", produitId: "moteur_relance", objectif: `Automatiser la phase de relance des lignes représentants des visites nécessitant une MAJ des informations de suivi.`, description: `L'agent interroge la matrice de contact pour identifier le destinataire selon le critère de la ligne. Il rédige le mail selon le ton défini puis l'envoie ou le place en brouillon.`, votac: { valeur: 5, occurrence: 4, temps: 5, ia: 5, facilite: 4, total: 23 }, package: "P1", statut: "A valider", outils: ["N8N", "API Outlook", "Base de données Immat X Contact"], prerequis: [`Matrice de contact construite (immat / régiment / prestataire → email — prérequis transverse à tous les usages)`, `Ton de relance défini (ton du mail, objet, niveau de formalité par contexte d'usage)`, `Mode d'envoi choisi (brouillon à valider human-in-loop vs envoi automatique)`], casUsageLies: ["CU-8"] },
    { id: "SN10.3-CU8", fonctionnalite: "Analyse & Intégration ERP (CU-8 Reporting VT4)", produitId: "moteur_relance", objectif: `Automatiser la complétude du fichier Excel et de l'ERP suite aux réponses aux relances.`, description: `L'agent synthétise les retours des concessions suite aux relances par mail et intègre ces justifications dans le fichier excel ainsi que dans l'ERP. Nécessite API Zadig écriture.`, votac: { valeur: 5, occurrence: 4, temps: 5, ia: 5, facilite: 2, total: 21 }, package: "P3", statut: "A valider", outils: ["N8N", "API Outlook", "Excel", "API ZADIG ECRITURE"], prerequis: [`API Zadig en écriture — prérequis bloquant partagé, validation formelle avec l'éditeur + process rollback`, `Règles d'extraction définies (ce que l'agent doit extraire de la réponse selon le contexte d'usage)`], casUsageLies: ["CU-8"] },
    ...
    { id: "SN10.2-CU9", fonctionnalite: "Relance (CU-9 Pénalités Arquus)", produitId: "moteur_relance", objectif: `Automatiser la phase de relance des lignes représentants des visites en risque de pénalité.`, description: `L'agent Moteur de relance identifie les lignes de l'Excel nécessitant une justification et lance les relances nécessaires auprès des concessions concernées.`, votac: { valeur: 3, occurrence: 4, temps: 5, ia: 5, facilite: 4, total: 21 }, package: "P1", statut: "A valider", outils: ["N8N", "API Outlook", "Base de données Immat X Contact"], prerequis: [`Matrice de contact construite (immat / régiment / prestataire → email — prérequis transverse à tous les usages)`, `Ton de relance défini (ton du mail, objet, niveau de formalité par contexte d'usage)`, `Mode d'envoi choisi (brouillon à valider human-in-loop vs envoi automatique)`], casUsageLies: ["CU-9"] },
    { id: "SN10.3-CU9", fonctionnalite: "Analyse & Intégration ERP (CU-9 Pénalités Arquus)", produitId: "moteur_relance", objectif: `Automatiser la complétude du fichier de pénalités suite aux justifications des concessionnaires.`, description: `L'agent synthétise les retours des concessions suite aux relances et intègre les justifications dans le fichier excel exposé en comité pénalités Arquus. Nécessite API Zadig écriture.`, votac: { valeur: 3, occurrence: 4, temps: 5, ia: 5, facilite: 2, total: 19 }, package: "P3", statut: "A valider", outils: ["N8N", "API Outlook", "Excel", "API ZADIG ECRITURE"], prerequis: [`API Zadig en écriture — prérequis bloquant partagé, validation formelle avec l'éditeur + process rollback`, `Règles d'extraction définies (ce que l'agent doit extraire de la réponse selon le contexte d'usage)`], casUsageLies: ["CU-9"] },
    { id: "SN10.3.1", fonctionnalite: "Relance si pas de réponse (ALL)", produitId: "moteur_relance", objectif: `Relancer automatiquement si aucune réponse n'est reçue dans le délai imparti, sans intervention manuelle.`, description: `Si aucune réponse après X jours, l'agent déclenche une nouvelle relance avec un ton plus pressant. Le cycle est limité à N relances avant escalade vers un collaborateur.`, votac: { valeur: 3, occurrence: 4, temps: 3, ia: 5, facilite: 4, total: 19 }, package: "P1", statut: "A valider", outils: ["N8N", "API Outlook", "Base de données Immat X Contact"], prerequis: [`Règle d'escalade définie (qui reçoit l'alerte si le cycle de relance atteint sa limite sans réponse)`, `Délai de non-réponse paramétré`], casUsageLies: ["CU-10"] },
    ...
    { id: "SN13.1", fonctionnalite: "Dashboard impact collaborateur", produitId: "dashboard_pilotage", objectif: `Permettre à chaque collaborateur de visualiser l'impact de ses actions sur les KPIs de la Plateforme et de se situer par rapport à une période de référence.`, description: `Traduit les actions individuelles (relances envoyées, devis traités…) en impact sur les indicateurs clés. Comparaison par période.`, votac: { valeur: 3, occurrence: 3, temps: 3, ia: 5, facilite: 1, total: 15 }, package: "P3", statut: "A valider", outils: ["VM", "Site"], prerequis: [`Modélisation actions → KPI (définir formellement comment chaque action individuelle impacte les KPIs — travail analytique préalable)`], casUsageLies: ["CU-13"] }
  ],
  useCasesList: [
